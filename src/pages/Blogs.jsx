...
import { Plus, Trash2, Edit3, BookOpen, ArrowRight, Sparkles } from "lucide-react";
        ...
        <AdminLayout>
            <div className="w-full min-h-screen relative overflow-hidden bg-gradient-to-br from-[#EAF6F6] via-[#F0FBFA] to-[#E8F5F3]">
                ...
                .liquid-glass::before {
                    ...
                    height: 200%;
                    background: 
                        radial-gradient(circle at 20% 50%, rgba(127,220,210,0.1), transparent 50%),
                        radial-gradient(circle at 80% 80%, rgba(255,201,163,0.1), transparent 50%);
                ...
                @media (prefers-reduced-motion: reduce) {
                    .tlc-blob, .tlc-fade-up, .float-in, .blog-card, .blog-card:hover {
                        animation: none;
                        transform: none;
                    }
                }
            `}</style>
                ...
                <div className="relative z-10 w-full px-6 md:px-12 py-16">
                    <div className="max-w-7xl mx-auto">
                        ...
                        {/* HEADER SECTION */}
                        <div className="mb-16">
                            <div className="tlc-fade-up flex items-center gap-3 mb-4" style={{ animationDelay: "0ms" }}>
                            ...
                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                                <div className="tlc-fade-up" style={{ animationDelay: "100ms" }}>
                        ...
                        {/* STATS CARD */}
                        <div className="tlc-fade-up tlc-glass-premium liquid-glass rounded-3xl p-8 md:p-12 mb-16 relative overflow-hidden" style={{ animationDelay: "300ms" }}>
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-[#4A5D6B] text-sm font-semibold mb-3 uppercase tracking-wide">Total Published Stories</p>
                        ...
                        {loading && (
                            <div className="tlc-glass-premium rounded-3xl p-16 text-center">
                                <div className="inline-block">
                                    ...
                                    <p className="text-[#4A5D6B] font-semibold">Loading your blogs...</p>
                                </div>
                            </div>
                        )}
                        ...
                        {!loading && blogs.length === 0 && (
                            <div className="tlc-glass-premium liquid-glass rounded-3xl p-20 text-center relative overflow-hidden">
                                ...
                                <h2 className="tlc-display text-3xl font-bold text-[#0D2B3E] mb-4">No Stories Yet</h2>
                        ...
                        {!loading && blogs.length > 0 && (
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {blogs.map((blog, index) => (
                                    <div
                                        key={blog._id}
                                        className="blog-card tlc-glass liquid-glass rounded-3xl p-8 flex flex-col relative overflow-hidden float-in group cursor-pointer"
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center justify-between gap-3 mb-6">
                                            <span className={`px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wider backdrop-blur-sm ${blog.status === 'Published'
                                        ...
                                        <div className="flex gap-3 pt-4">
                                            ...
                                            <button
                                                ...
                                                className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-red-400/20 to-red-500/20 text-red-700 py-3 rounded-xl hover:from-red-400/40 hover:to-red-500/40 transition-all font-semibold text-sm group/btn"
                                            >
